        ...
        <Tabs value={activeTab} className="mx-auto max-w-4xl">
          <TabsList>
            <TabsTrigger
              ...
              nativeButton={false}
              render={
                <Link to="/$orgSlug/$projectSlug/overview" params={{ orgSlug, projectSlug }} />
              }
            >
              Overview
            </TabsTrigger>
            <TabsTrigger
              value="usage"
              nativeButton={false}
              render={<Link to="/$orgSlug/$projectSlug/usage" params={{ orgSlug, projectSlug }} />}
            >
              Usage
            </TabsTrigger>
          </TabsList>
