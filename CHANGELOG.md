...
## [0.31.3](https://github.com/camox-ai/camox/compare/camox-v0.31.2...camox-v0.31.3) (2026-05-27)
...
## [0.31.0](https://github.com/camox-ai/camox/compare/camox-v0.30.0...camox-v0.31.0) (2026-05-26)
...
* bring skills up to date ([642527b](https://github.com/camox-ai/camox/commit/642527b94c91289b18bb84097cd8415756e0f6e8))
...
* **web:** add feature-video-grid block ([a74cf99](https://github.com/camox-ai/camox/commit/a74cf990fa11e790c3041884bf19668c9335bd6b))
...
* enable publish button when changes are made ([bd6a7bd](https://github.com/camox-ai/camox/commit/bd6a7bd2c35d9a0526e5eda1f7828951df5717ea))
* replicate checkpoints when transferring environments ([d2bbaa8](https://github.com/camox-ai/camox/commit/d2bbaa83f84e9795761e054b6e9022d0397b305f))
* toggle agent chat action ([6b98c86](https://github.com/camox-ai/camox/commit/6b98c86b69adb95c04d7876b368284e1e81fcb25))

## [0.27.0](https://github.com/camox-ai/camox/compare/camox-v0.26.0...camox-v0.27.0) (2026-05-18)
...
* circular dependency preventing api startup ([b439d47](https://github.com/camox-ai/camox/commit/b439d47fdd20ab2dc3494b3a3b0228a377222ae0))
...
* delete implemented plan files ([f4f944c](https://github.com/camox-ai/camox/commit/f4f944cef2f0f1bf6daea478201764130b606620))
...
## [0.26.0](https://github.com/camox-ai/camox/compare/camox-v0.25.0...camox-v0.26.0) (2026-05-18)
...
* publish initial pages on project creation ([c55b04a](https://github.com/camox-ai/camox/commit/c55b04a7c2a49f672281f299a0cc5ef239da683a))
...
* serve LLM small version of images for img generation ([392b9a7](https://github.com/camox-ai/camox/commit/392b9a7e217af262b15877fd0704649e009ec02f))
...
* tell agents not to author commits ([83b0d14](https://github.com/camox-ai/camox/commit/83b0d1490e52f78ff6b314625b4a4095f4ee92d5))
...
* file asset swap ([57ad5ce](https://github.com/camox-ai/camox/commit/57ad5cebf37aea266588b81bc78b785a1b52abfc))
...
## [0.10.1](https://github.com/camox-ai/camox/compare/camox-v0.10.0...camox-v0.10.1) (2026-04-20)
...
* remove concurrently ([4c94d95](https://github.com/camox-ai/camox/commit/4c94d95c1efa3301a8ce81c29de4c24e5d89785e))

## [0.10.0](https://github.com/camox-ai/camox/compare/camox-v0.9.1...camox-v0.10.0) (2026-04-19)
...
* websocket authentication ([d6f6ccc](https://github.com/camox-ai/camox/commit/d6f6ccc48ff0e21d6071736c5298a246fdd996f5))
...
## [0.9.1](https://github.com/camox-ai/camox/compare/camox-v0.9.0...camox-v0.9.1) (2026-04-18)
...
* extract pathless authorize layout ([f2ff4a1](https://github.com/camox-ai/camox/commit/f2ff4a108f73a159e19aea9f523a245a77ac7b80))
* fix auth client type safety ([0084668](https://github.com/camox-ai/camox/commit/0084668e48137f49ec9024468758437c741209cf))
* run studio in api dev script via concurrently ([fe92458](https://github.com/camox-ai/camox/commit/fe92458391522e8cf67a9a5f8d71fe38b46f4ae7))
* **web:** organize route files in folders ([ee93ee8](https://github.com/camox-ai/camox/commit/ee93ee8450ebfcee8b2b8aa2cc574c7041ae0980))
...
## [0.6.0](https://github.com/camox-ai/camox/compare/camox-v0.5.2...camox-v0.6.0) (2026-04-14)
...
* add create-camox to release-please config ([45212d1](https://github.com/camox-ai/camox/commit/45212d140ef1952ac69d4fbe30489ede1a64f587))
...
* **web:** project settings ui tweaks ([e96c2b3](https://github.com/camox-ai/camox/commit/e96c2b39af3459c2960b3a168323c0baf24057e9))
...
## [0.3.0](https://github.com/camox-ai/camox/compare/camox-v0.2.0...camox-v0.3.0) (2026-04-12)
...
* add org switcher to dashboard navbar ([4ad6d29](https://github.com/camox-ai/camox/commit/4ad6d29388e6385750e0718b53f8635c3da2f3f6))
...
* add project creation guide to web app ([aaadcb0](https://github.com/camox-ai/camox/commit/aaadcb03c6c2454f96206f31e3205050c8227555))
...
* **cli:** add login and logout commands ([3461d76](https://github.com/camox-ai/camox/commit/3461d76796a0219e9a286bff3754fa2e8dae2510))
* create org in org picker ([b5a0fb1](https://github.com/camox-ai/camox/commit/b5a0fb13b8d2db6a1119599996acc7eb2ad3e47b))
...
* release ci ([85646ce](https://github.com/camox-ai/camox/commit/85646ce85b73997fdc7d2dab861aa683cc6cd0ef))
* release please drop alpha tag ([9d4ce8a](https://github.com/camox-ai/camox/commit/9d4ce8aaa6a1a42f2f445738ff5d8297916da2a9))
...
* **web:** ssr not getting session ([040ba9d](https://github.com/camox-ai/camox/commit/040ba9d72bc5baa36dd5522e9307830cdae43426))
...
* add readme image ([fb9b6d8](https://github.com/camox-ai/camox/commit/fb9b6d86171e3fb40cd8a0481d9e38ff691cad0f))
...
* batch github releases per version ([565afa0](https://github.com/camox-ai/camox/commit/565afa080720fd1993423eb5fe059b1ad8d101c7))
...
* **cli:** migrate to oblique ([1375381](https://github.com/camox-ai/camox/commit/1375381f53ec2bfdb43328151bdbad2443f551c0))
* declutter oxlint configs ([9a89597](https://github.com/camox-ai/camox/commit/9a89597310a97606894f59c76e4881ee1d281f69))
* delete legacy convex backends ([d7dd53f](https://github.com/camox-ai/camox/commit/d7dd53fcb4427a682747bdf08b7f897b1c5c872a))
...
* delete unused create-camox package ([b85b85c](https://github.com/camox-ai/camox/commit/b85b85c28a4ab4ea4cd908e8cf1ef3a7fd1f7e70))
...
* enforce conventional commits ([d396b4c](https://github.com/camox-ai/camox/commit/d396b4c109aa71aeec00036b3faba143f085b0d9))
...
* release as stable instead of alpha ([ef9fde9](https://github.com/camox-ai/camox/commit/ef9fde97379f7e891012c847a5f539184745d41e))
...
* remove git initialization from cli init command ([365835f](https://github.com/camox-ai/camox/commit/365835f96b3379c1e802f07b781935f8e89dc8dc))
...
* **web:** add org to dashboard url path ([92c3b83](https://github.com/camox-ai/camox/commit/92c3b8348d7066c22ab668669a643b0c01dfae80))

## [0.2.0-alpha.5](https://github.com/camox-ai/camox/compare/camox-v0.2.0-alpha.4...camox-v0.2.0-alpha.5) (2026-04-10)
...
## [0.2.0-alpha.4](https://github.com/camox-ai/camox/compare/camox-v0.2.0-alpha.3...camox-v0.2.0-alpha.4) (2026-04-10)
...
## [0.2.0-alpha.3](https://github.com/camox-ai/camox/compare/camox-v0.2.0-alpha.2...camox-v0.2.0-alpha.3) (2026-04-10)
...
## [0.2.0-alpha.2](https://github.com/camox-ai/camox/compare/camox-v0.1.2-alpha.2...camox-v0.2.0-alpha.2) (2026-04-10)
